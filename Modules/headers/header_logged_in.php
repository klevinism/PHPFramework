...
float: right;
  ...
  <div class="header">
   ...
   <div class="logo">
    ...
    margin-top: 17px;
    color: #fff;
"><a href="new_post" style="color:#fff;">PUBBLICA ANNUNCIO</a></span><span align="center" style="
     width: 22%;
  float: right;
  /* background: linear-gradient(to bottom, #2f7abb 0%,#26649a 100%); */
  height: 38px;
  ...
  font-size: 16px;
  font-weight: 500;
">Welcome <?php echo $user->getUsername();?> <br/><a href="dashboard">dashboard</a> | <a href="logout" >logout</a></span>
